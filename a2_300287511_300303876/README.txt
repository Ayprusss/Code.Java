...
this folder contains 18 files individual files, along with the file classes themselves. These 18 files also include the output files, as well as the .inf files to run the simulation itself. 
these files include: 
